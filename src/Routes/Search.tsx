...
import { findMovies, getClipDetails, getDetail, getRecommend, IGetMoviesResult, findTv } from "../Api/api";
...
function Search() {
    ...
    const keyword = new URLSearchParams(location.search).get("keyword"); // URLSearchParams는 url의 query를 가져온다.
    ...
    const { data: tv, isLoading: isTvLoading } =
        useQuery<IGetMoviesResult>([keyword, "tv"], () => findTv(keyword));
